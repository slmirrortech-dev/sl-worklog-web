...
import ModalEditLock from '@/app/admin/(main)/old-setting-line/_component/ModalEditLock'
...
import LineTable from '@/app/admin/(main)/old-setting-line/_component/LineTable'
import LineRow from '@/app/admin/(main)/old-setting-line/_component/LineRow'
