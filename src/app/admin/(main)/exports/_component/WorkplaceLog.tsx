...
import { Download, FileSpreadsheet, Plus, Settings, X } from 'lucide-react'
...
const WorkplaceLog = () => {
  ...
  // 개별 상태 관리
  const { searchStates, logQuery, resetFilters, page, setPage, pageSize, setPageSize, totalCount } =
